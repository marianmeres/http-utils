...
export class HTTP_STATUS {
	...
	static readonly UNPROCESSABLE_CONTENT =
		HTTP_STATUS.ERROR_CLIENT.UNPROCESSABLE_CONTENT.CODE;
	static readonly TOO_MANY_REQUESTS = HTTP_STATUS.ERROR_CLIENT.TOO_MANY_REQUESTS.CODE;

	// 5xx
	static readonly INTERNAL_SERVER_ERROR =
		HTTP_STATUS.ERROR_SERVER.INTERNAL_SERVER_ERROR.CODE;
	static readonly NOT_IMPLEMENTED = HTTP_STATUS.ERROR_SERVER.NOT_IMPLEMENTED.CODE;
	static readonly SERVICE_UNAVAILABLE =
		HTTP_STATUS.ERROR_SERVER.SERVICE_UNAVAILABLE.CODE;
